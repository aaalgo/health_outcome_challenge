    ...
    for year in [2011, 2012, 2013, 2014, 2015]:
        ...
        for ctype in ['car', 'dme']:
            for sub in ['claimsj', 'linej']:
                tasks.append(('%s_%s_lds_5_%d' % (ctype, sub, year), (year, ctype, sub)))
            pass
...
if __name__ == '__main__':
    ...
    meta_name = 'meta.pkl'
    assert not os.path.exists(meta_name), "meta.pkl exists"
    with open(meta_name, 'wb') as f:
        pickle.dump((cms.META_VERSION, formats, lookup), f)
        pass
